...
import random
import argparse
from evl.evaluator_base import Evaluator
...
class Trainer(object):
    def __init__(self,  weight_path, resume, gpu_id):
        ...
        self.train_dataset = data.VocDataset(anno_file_type="train_bs/train_bs_2", img_size=cfg.TRAIN["TRAIN_IMG_SIZE"])
        ...
        for para in self.yolov3._Yolov3__head_s_fs.parameters():
            para.requires_grad = False
        
        for para in self.yolov3._Yolov3__head_m_fs.parameters():
            para.requires_grad = False
        
        for para in self.yolov3._Yolov3__head_l_fs.parameters():
            para.requires_grad = False
