...
class Yolov3(nn.Module):
    ...
    def __init__(self, init_weights=True):
        ...
        # bs_prediction
        # small
        self.__head_s = Yolo_head(nC=self.__nC, anchors=self.__anchors[0], stride=self.__strides[0], in_channel=128, out_channel=self.__out_channel)
        # medium
        self.__head_m = Yolo_head(nC=self.__nC, anchors=self.__anchors[1], stride=self.__strides[1], in_channel=256, out_channel=self.__out_channel)
        # large
        self.__head_l = Yolo_head(nC=self.__nC, anchors=self.__anchors[2], stride=self.__strides[2], in_channel=512, out_channel=self.__out_channel)

        # fs_prediction
        # small
        self.__head_s_fs = Yolo_head(nC=self.__nC, anchors=self.__anchors[0], stride=self.__strides[0], in_channel=128, out_channel=self.__out_channel)
        # medium
        self.__head_m_fs = Yolo_head(nC=self.__nC, anchors=self.__anchors[1], stride=self.__strides[1], in_channel=256, out_channel=self.__out_channel)
        # large
        self.__head_l_fs = Yolo_head(nC=self.__nC, anchors=self.__anchors[2], stride=self.__strides[2], in_channel=512, out_channel=self.__out_channel)
